...
namespace TraderUtils
{
    public class MD5Crypt
    {
        ...
        /// <param name="salt">The salt or the pepper of the password if it is empty it will be random generated</param>
        ...
        public static String crypt(String password, String salt)
        {
			...
			if (string.IsNullOrEmpty(salt))
			{
				...
				salt = Convert.ToBase64String(saltBytes).Remove(random.Next(4,8));
			}
